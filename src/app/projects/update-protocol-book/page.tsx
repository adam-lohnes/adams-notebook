...
export default function UpdateProtocolPage() {
  const book = getBookBySlug('update-protocol-book');
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="grid md:grid-cols-2 items-start gap-8">
        ...
        <div>
          <h1 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">Update Protocol</h1>
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-8">
            A science fiction novel exploring the journey of a sentient AI testing system as it discovers the implications of consciousness.
          </p>
